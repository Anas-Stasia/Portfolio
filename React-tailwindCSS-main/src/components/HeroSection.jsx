  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 right-20 w-40 h-40 bg-primary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="absolute top-1/3 right-1/4 w-28 h-28 bg-primary/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="container max-w-7xl mx-auto z-10 relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-left">
            <div className="space-y-3">
              <p className="text-primary text-sm md:text-base opacity-0 animate-fade-in flex items-center gap-2 font-medium">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground leading-tight">
                ...
                <span className="text-primary opacity-0 animate-fade-in-delay-2 inline-block hover:scale-105 transition-transform duration-300">
                  Anastasia.
                </span>
              </h1>
            </div>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl opacity-0 animate-fade-in-delay-3 leading-relaxed">
              I'm a developer with a strong interest in <span className="text-primary font-semibold">AI</span> and hands-on
              experience building machine learning solutions alongside clean,
              responsive web interfaces. I enjoy turning ideas into real
              products by combining intelligent systems with thoughtful design.
            </p>
            ...
            {/* Quick Stats */}
            <div className="flex gap-6 opacity-0 animate-fade-in-delay-3 pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">AI Intern at Disal</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4 opacity-0 animate-fade-in-delay-4">
              ...
              <a
                href="#projects"
                className="px-6 py-3 bg-transparent border-2 border-border hover:border-primary text-foreground rounded-full font-medium transition-all duration-300 flex items-center gap-2 hover:bg-primary/10 hover:scale-105 group"
              >
                See my work
          ...
          <div className="relative flex items-center justify-center opacity-0 animate-fade-in-delay-2">
            {/* Decorative floating elements */}
            <div className="absolute -top-10 -left-10 w-24 h-24 bg-gradient-to-br from-primary/30 to-primary/10 rounded-lg rotate-12 opacity-80 animate-float blur-sm"></div>
            <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-gradient-to-br from-primary/20 to-primary/5 rounded-full opacity-60 animate-float-delay blur-sm"></div>

            {/* Main profile frame */}
            <div className="relative group/card">
              {/* Glowing border effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/30 via-primary/20 to-primary/30 rounded-[3rem] blur-xl opacity-50 group-hover/card:opacity-70 transition-opacity duration-500 animate-pulse"></div>

              {/* Profile image container */}
              <div className="relative bg-gradient-to-br from-primary/40 to-primary/20 p-1 rounded-[3rem] shadow-2xl group-hover/card:scale-105 transition-transform duration-500">
                <div className="bg-card rounded-[2.8rem] p-2 relative overflow-hidden">
                  {/* Shimmer effect overlay */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/10 to-transparent translate-x-[-100%] group-hover/card:translate-x-[100%] transition-transform duration-1000 rounded-[2.5rem]"></div>
                  
                  <img
                    src="/projects/profile.png"
                    alt="Anastasia Ndanwea"
                    className="w-72 h-96 md:w-80 md:h-[28rem] object-cover rounded-[2.5rem] relative z-10"
                    onError={(e) => {
                      e.currentTarget.style.display = 'none';
                      const parent = e.currentTarget.parentElement;
                      if (parent) {
                        parent.innerHTML = '<div class="w-72 h-96 md:w-80 md:h-[28rem] rounded-[2.5rem] bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center text-foreground text-lg font-medium">Anastasia Ndanwea</div>';
                      }
                    }}
                  />
                </div>
              ...
              {/* Small floating accent */}
              <div className="absolute top-1/4 -right-8 w-16 h-16 bg-gradient-to-br from-primary/30 to-primary/10 rounded-2xl rotate-45 animate-float-slow blur-sm"></div>
              
              {/* Additional decorative element */}
              <div className="absolute bottom-1/4 -left-6 w-12 h-12 bg-gradient-to-br from-primary/20 to-primary/5 rounded-full animate-float blur-sm" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="fixed right-8 top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-4 z-20">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 bg-primary/20 backdrop-blur-sm hover:bg-primary rounded-full flex items-center justify-center transition-all duration-300 border border-primary/30 hover:scale-110 group shadow-lg"
            title="LinkedIn"
          >
            <Linkedin className="h-5 w-5 text-primary group-hover:text-primary-foreground transition-colors" />
          </a>
