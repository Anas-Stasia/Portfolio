...
import { Briefcase, Code, User, Download, Mail, Brain } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="group relative bg-card border border-border rounded-xl p-6 card-hover overflow-hidden transition-all duration-300 hover:border-primary/50">
              ...
              <div className="flex items-start gap-4 relative z-10">
                <div className="p-3 rounded-xl bg-primary/10 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                  <Brain className="w-6 h-6 text-primary group-hover:text-primary-foreground transition-colors" />
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-lg mb-2 group-hover:text-primary transition-colors">AI Model Fine-Tuning</h4>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    During my internship at Disal, I worked on an AI-assisted radiology report generation system using MedGemma-4B-IT. 
                    Involved dataset preparation, fine-tuning, and evaluation metrics for medical image-to-text tasks.
                  </p>
                </div>
              </div>
            </div>
